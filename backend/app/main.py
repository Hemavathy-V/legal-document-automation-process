...
Routes are grouped by feature: login, contracts, templates, clauses.
"""
import sys
import os
...
from app.routers import contracts_router, login_router, templates_router, generator_router
