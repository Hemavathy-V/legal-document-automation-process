...
(
    ...
    'India',
    'Medium',
    'The Client shall pay all undisputed invoices within thirty (30) days from the date of receipt.',
    'Admin'
),
(
    'Accelerated Payment Terms - 15 Days',
    'Payment',
    'MSA',
    'India',
    'High',
    'The Client shall settle all undisputed invoices within fifteen (15) days from the date of invoice.',
    'Admin'
),
(
    ...
    'India',
    'High',
    'The Service Provider shall be strictly liable for any direct damages arising from breach of this Agreement.',
    'Admin'
),
(
    ...
    'India',
    'Medium',
    'The liability of either party shall be limited to the total fees paid under this Agreement.',
    'Admin'
),
(
